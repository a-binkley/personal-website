export function SocialLink(props: { href: string; }) {
    ...
    return (
        <a href={props.href} target='_blank' rel='noreferrer' style={{ color: '#3f3f3f' }}>
            <svg xmlns='http://www.w3.org/2000/svg' width='64' height='64' fill='currentColor' className={`bi bi-${props.href}`} viewBox='0 0 16 16'>
                <path d={svgPaths[props.href.split('/')[2].slice(0, -4)]}/>
            </svg>
        </a>
    );
};
